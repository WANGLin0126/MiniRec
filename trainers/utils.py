...
def get_tokenizer(model_name):
    ...
    if "deepseek-distill-qwen" in str(tokenizer.__class__).lower() or "deepseek" in model_name.lower():
        tokenizer.__setattr__('generation_prompt', "<｜Assistant｜>")
        tokenizer.__setattr__('generation_end', "<｜end▁of▁sentence｜>")
